      ...
      <div class="pages">
        ...
        <section id="main">
            ...
            <br>
              ...
              <div class="container">
                <fieldset class="todo">
                  <?php $results = mysqli_query($db, "SELECT * FROM todo_fitness t INNER JOIN parent p ON t.username = p.childUsername WHERE p.username='".$_SESSION['username']."'"); ?>
            ...
            <div class="container">
                <fieldset class="completed">
                  <?php $results = mysqli_query($db, "SELECT * FROM completed_fitness t INNER JOIN parent p ON t.username = p.childUsername WHERE p.username='".$_SESSION['username']."'"); ?>
